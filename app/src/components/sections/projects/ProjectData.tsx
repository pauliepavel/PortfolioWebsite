...
export const ProjectData: ProjectData[] = [
  {
    ...
    images: [
      ...
      "/images/Snímek obrazovky (83).png",
      "/images/Snímek obrazovky (84).png",
      "/images/Snímek obrazovky (85).png",
      "/images/Snímek obrazovky (86).png",
      "/images/Snímek obrazovky (87).png",
      "/images/Snímek obrazovky (88).png",
      "/images/Snímek obrazovky (80).png",
      "/images/Snímek obrazovky (89).png",
      "/images/Snímek obrazovky (90).png",
      "/images/Snímek obrazovky (91).png",
      "/images/Snímek obrazovky (92).png",
      "/images/Snímek obrazovky (93).png",
    ],
    tags: ["Typescript", "React", "Tailwind", "API", "SPA React routing", "JSON Server"],
  },
  {
    id: "nutritionist",
